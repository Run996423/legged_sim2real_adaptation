...
class Go1AdaptationCfg(LeggedRobotCfg):
    class env(LeggedRobotCfg.env):
        ...
        history_length = 10
        property_dim = 4
        num_supervised_latent = 3 + 3  # lin_vel, disturbance
        num_privileged_obs = num_observations + 3 + 3  # lin_vel, disturbance
...
class Go1AdaptationCfgPPO:
    seed = 1
    runner_class_name = 'OnPolicyRunnerForSupervisedLatent'

    class policy:
        class_name = 'ActorCriticSupervisedLatent'
    ...
    class algorithm:
        class_name = 'PPOSupervisedLatent'
        # training params
        value_loss_coef = 1.0
        latent_loss_coef = 3.
