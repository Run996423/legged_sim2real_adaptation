...
class RolloutStorageForSupervisedLatent:
    class Transition:
        def __init__(self):
            self.obs_history = None
            self.current_obs = None
            self.privileged_observations = None
            self.supervised_latent_ground_truth = None
            self.actions = None
            self.rewards = None
            self.dones = None
            self.values = None
    ...
    def __init__(
        ...
        self.supervised_latent_ground_truth_shape = supervised_latent_ground_truth_shape
        ...
        self.supervised_latent_ground_truths = torch.zeros(*header, *supervised_latent_ground_truth_shape,
                                                           device=self.device)
    ...
    def add_transitions(self, transition: Transition):
        ...
        self.supervised_latent_ground_truths[self.step].copy_(transition.supervised_latent_ground_truth)
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        supervised_latent_ground_truths = self.supervised_latent_ground_truths.flatten(0, 1)
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                supervised_latent_ground_truths_batch = supervised_latent_ground_truths[batch_idx]
